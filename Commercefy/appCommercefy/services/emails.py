...
class EmailService:
    ...
    def send_verification_email(user, token, verification_url):
        ...
        return EmailService.send_email(
            subject,
            'appCommercefy/emails/verification_email.html',
            context,
            [user.email]
        )
    ...
    def send_order_confirmation(order):
        ...
        return EmailService.send_email(
            subject,
            'appCommercefy/emails/order_confirmation.html',
            context,
            [recipient]
        )
    ...
    def send_marketing_email(subject, body_html, recipient_list):
        ...
        for email in recipient_list:
            ...
            html_content = render_to_string('appCommercefy/emails/marketing_email.html', context)
            text_content = strip_tags(html_content)
