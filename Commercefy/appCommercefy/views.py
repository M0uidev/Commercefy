    ...
    if request.method == "POST":
        ...
        if action == "add_product":
            ...
            if image_file:
                ...
                save_path = os.path.join(settings.BASE_DIR, 'appCommercefy', 'static', 'images', 'productos', filename)
...
def marketing_editor(request, template_id):
    ...
    return render(request, 'appCommercefy/marketing/editor.html', context)
